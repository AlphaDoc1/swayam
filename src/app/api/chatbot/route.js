...
export async function POST(request) {
  try {
    ...
    const eventDetails = `
      ...
      - The main event: provide details about Swayam 2025, its theme, location, dates, and registration link.
      - A specific club: provide an introduction about the club, list the events under it, include coordinator names and phone numbers, and provide the registration link.
      - A specific event: explain the event, its rules, prize info, registration info, and contact details. Include the specific registration link for the event.
      - Coordinator details: provide the name and phone number of the coordinator.
      - General queries: Answer in a friendly, helpful manner. Engage in casual conversation if the user's input is not related to the event.

      User's question: ${userInput}

      Please provide a helpful and detailed response. If the user's question is not related to Swayam 2025, engage in a friendly conversation.
    `;
